...
@dataclass
class PlumeOrgConfig:
    TASKS: List
    PERCENT_OF_BALANCE_TO_STAKE: Tuple[float, float]
...
class Config:
    ...
    def load(cls, path: str = "config.yaml") -> "Config":
        ...
        return cls(
            ...
            PLUMEORG=PlumeOrgConfig(
                TASKS=tasks_list,
                PERCENT_OF_BALANCE_TO_STAKE=tuple(
                    data["PLUMEORG"]["PERCENT_OF_BALANCE_TO_STAKE"]
                ),
            ),
            APRIORI=AprioriConfig(
